...
const mobileNavItems: { id: SidebarCategory; label: string; shortLabel: string; icon: React.ElementType }[] = [
  ...
  { id: "trash", label: "Trash", shortLabel: "Trash", icon: Trash2 },
];
...
const DashboardSidebar = () => {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex w-60 bg-card border-r border-border h-full flex-shrink-0 flex-col">
        {/* Logo Section */}
        <div className="p-4 flex items-center gap-3">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center overflow-hidden shadow-sm">
              <img src={Logo} alt="SuiSign Logo" className="w-5 h-5 object-contain" />
            </div>
            <span className="text-[15px] font-bold text-foreground tracking-tight">SuiSign</span>
          </button>
        </div>
